...
* [email discussion list sign up](https://perl-guilds.net/mailman/listinfo/openmp_perl-guilds.net) @ _perl-guilds.net_ [archive](https://perl-guilds.net/pipermail/openmp_perl-guilds.net/)
